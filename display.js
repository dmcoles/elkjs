...
ElkJs.Display = function (opts) {
    ...
    var littleEndianColours = new Uint32Array([0xff000000, 0xff0000ff, 0xff00ff00, 0xff00ffff,
				   0xffff0000, 0xffff00ff, 0xffffff00, 0xffffffff]);

    var bigEndianColours = new Uint32Array([0x000000ff, 0xff0000ff, 0x00ff00ff, 0xffff00ff,
        ...
        switch (sheila.screenMode) {
            case 0:
                for (x = 0; x < 640; x += 8) {
                    ...
                    colour = littleEndianColours[sheila.palette[(m & 128) >> 7]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    colour = littleEndianColours[sheila.palette[(m & 64) >> 6]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    colour = littleEndianColours[sheila.palette[(m & 32) >> 5]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    colour = littleEndianColours[sheila.palette[(m & 16) >> 4]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    colour = littleEndianColours[sheila.palette[(m & 8) >> 3]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    colour = littleEndianColours[sheila.palette[(m & 4) >> 2]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    colour = littleEndianColours[sheila.palette[(m & 2) >> 1]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    colour = littleEndianColours[sheila.palette[(m & 1)]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
            ...
            case 1:
                for (x = 0; x < 320; x += 4) {
                    ...
                    colour = littleEndianColours[sheila.palette[((m & 128) >> 6) | ((m & 8) >> 3)]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    ...
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    colour = littleEndianColours[sheila.palette[((m & 64) >> 5) | ((m & 4) >> 2)]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    ...
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    colour = littleEndianColours[sheila.palette[((m & 32) >> 4) | ((m & 2) >> 1)]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    ...
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    colour = littleEndianColours[sheila.palette[((m & 16) >> 3) | ((m & 1))]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
            ...
            case 2:
                for (x = 0; x < 160; x += 2) {
                    ...
                    colour = littleEndianColours[sheila.palette[((m & 128) >> 4) | ((m & 32) >> 3) | ((m & 8) >> 2) | ((m & 2) >> 1)]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
                    ...
                    colour = littleEndianColours[sheila.palette[((m & 64) >> 3) | ((m & 16) >> 2) | ((m & 4) >> 1) | ((m & 1))]];
                    data[pixelIndex++] = colour & 0xff;
                    data[pixelIndex++] = (colour & 0xff00) >> 8;
                    data[pixelIndex++] = (colour & 0xff0000) >> 16;
                    data[pixelIndex++] = 255;
